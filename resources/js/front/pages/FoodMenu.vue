...
<template>
    <HeaderSection header-one="Co si dáte?" header-two="U Sajmona…" img="food-hand-drawing" />

    <FlexSection v-if="sections && sections.length">
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-10 w-full mt-[200px]">
    ...
    <FlexSection v-else>
        <div class="block w-full mt-32 text-center">
            <p class="text-lg text-dark/60">Momentálně nemáme k dispozici žádný jídelní lístek.</p>
        </div>
    </FlexSection>
