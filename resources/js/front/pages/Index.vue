...
<template>
    ...
    <FullSection>
        <div class="flex justify-center">
            <AnimateSvgItem class="w-3/12 text-accent -mt-32">
                <Line1 />
            </AnimateSvgItem>
        </div>
    </FullSection>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-20 -mt-[210px]">
                ...
                <div class="block pt-[90px] space-y-10">
                    <p>
                        ...
                        či do kancelářObjednejte si bleskový rozvoz přes Bolt Food nebo Foodoru
                        přímo k vám domů či do kanceláře.
                    </p>
                    <p class="font-bold">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3">
                        <div class="block">
                            <img src="/img/logo/foodora-gr.svg" class="w-1/2" alt="logo Foodora" />
                        </div>
                        <div class="block">
                            <img src="/img/logo/wolt-gr.svg" class="w-1/2" alt="Logo Wolt" />
                            <p>Ponávka</p>
                        </div>
                        <div class="block">
                            <img src="/img/logo/wolt-gr.svg" class="w-1/2" alt="Logo Wolt" />
